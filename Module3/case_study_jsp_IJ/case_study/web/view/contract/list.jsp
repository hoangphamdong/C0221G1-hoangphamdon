        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6 d-flex">
                        <button type="button" class="btn btn-info add-new mr-5">Back Home</button>
                    ...
                    <div class="col-sm-6">
                        <div class="search-box d-flex">
                            ...
                            <form action="/contract">
                                ...
                                <input class="btn btn-outline-success" type="submit" value="Create New Contract"/>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th>Service Name<i class="fa fa-sort"></i></th>
                    <th>Contract start Date</th>
                    <th>Contract End Date<i class="fa fa-sort"></i></th>
                ...
                <c:forEach var="contract" items="${contracts}" varStatus="status">
                    <tr>
                        ...
                        <td><c:out value="${contract.getCustomerName() }"/></td>

                        <td><c:out value="${contract.getServiceName()}"/></td>

                        <td><c:out value="${contract.getContractStartDate()}"/></td>

                        <td><c:out value="${contract.getContractEndDate()}"/></td>

                        <td><c:out value="${contract.getAttachServiceName()}"/></td>
                        ...
                        <td>
                            ...
                            <button type="button" class="delete btn-danger"
                                    onclick="sendDataToModal('${contract.getContractId()}','${contract.getCustomerName()}')"
