            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <c:forEach var="customer" items="${customers}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="/customer?action=view&id=${customer.getCustomerId()}" class="view" title="View"
                               data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <a href="/customer?action=edit&id=${customer.getCustomerId()}" class="edit" title="Edit"
                               data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
<%--                            <button type="button"  class="delete btn-danger" title="Delete" data-toggle="tooltip"data-target="#exampleModalLong"--%>
