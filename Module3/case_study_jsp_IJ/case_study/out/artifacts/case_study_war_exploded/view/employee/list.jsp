...
<div class="container mt-5">
    ...
    <div class="d-flex">
        ...
        <form action="/employee" style="margin-left: 200px" class="d-flex">
        ...
        <form action="/employee" style="margin-left: 50px">
            <input type="hidden" name="action" value="create">
            <input class="btn btn-outline-success" type="submit" value="Create New Employee"
    ...
    <table class="table">
        ...
        <c:forEach var="employee" items="${employees}">
            <tr>
                <td><c:out value="${employee.getEmployee() }"/></td>
                <td>
                    <a href="/employee?action=view&id=${employee.getEmployee()}" class="text-dark">
                ...
                <td>
                    <a class="btn btn-primary" href="/customer?action=edit&id=${employee.getEmployee()}"
                       role="button">Edit</a>
                </td>
                <td>
                    <button type="button" class="btn btn-danger"
                            onclick="sendDataToModal('${employee.getEmployee()}','${employee.getEmployeeName()}')"
