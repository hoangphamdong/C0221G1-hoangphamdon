...
public class UserRepository {
    ...
    private static final String SELECT_GET_USER = "CALL get_user;";
    ...
    public List<User> selectUser() {
        ...
        try (Connection connection = baseRepository.getConnection();
             ...
             // Step 2:Create a statement using connection object
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_GET_USER);) {
            System.out.println(preparedStatement);
            // Step 3: Execute the query or update query
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean deleteUseById(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = baseRepository.getConnection(); PreparedStatement statement = connection.prepareStatement("call delete_user_by_id(?);");) {
            statement.setInt(1, id);
            rowDeleted = statement.executeUpdate() > 0;
        }
        return rowDeleted;
